...
*/
function creaCategoriaOri($idCategoriaOri){
        $res = array();
...
if (isset($_GET['posts'])){
        ...
        while( $registro = $result->fetch_row() ) {
                ...
                $idCategoria = creaCategoriaOri($idCategoriaOri);
                ...
                //$result = wp_insert_post($nuevoPost,true);
